...
BEGIN
    ...
    INSERT INTO employe_o e VALUES (
        1111111111111,
        'Dupont',
        'Marcello',
        'Caissier',
...
BEGIN
    ...
    FOR i IN res.first..res.last LOOP
        dbms_output.put_line('Facture à payer : ' || res(i).id);
    END LOOP;

    FOR i IN res1.first..res1.last LOOP
        dbms_output.put_line('Factures à encaisser : ' || res1(i).id);
    END LOOP;
...
BEGIN
    ...
    bool := res1.is_valid;
    IF bool THEN
        dbms_output.put_line('quantité in ticket '
                             || res1.id
                             || 'is valid');
    ELSE
        dbms_output.put_line('quantité in ticket '
